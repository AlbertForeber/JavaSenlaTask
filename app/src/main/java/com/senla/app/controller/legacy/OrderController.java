...
public class OrderController {
    ...
    public void createOrder() {
        ...
        try {
            if (orderService.createOrder(orderId, bookIds, customerName) != null) {
    ...
    public void changeOrderStatus() {
        ...
        try {
            if (orderService.changeOrderStatus(orderId, newStatus) != null) {
...
ioHandler.showMessage(Colors.YELLOW + e.getMessage() + Colors.RESET);
    ...
    public void getOrderDetails() {
        ...
        try {
            ...
            Order result = orderQueryService.getOrderDetails(orderId);
            ioHandler.showMessage(result != null ? result.toString() : Colors.YELLOW + "ЗАКАЗ С УКАЗАННЫМ ID НЕ НАЙДЕН" + Colors.RESET);
